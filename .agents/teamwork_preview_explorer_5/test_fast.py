"""Fast test optimization script for 20d projection strategy parameter investigation.
"""
import sys
import os
import logging
...
def test_wfo_config(sym, bounds, n_trials=100, min_trades_train=3, min_trades_oos=2, oos_dd_max=0.20, oos_pf_min=1.10):
    er_max = bot.get_er_max(sym)
...
if __name__ == '__main__':
    ...
    for sym in ['BTC/USDT', 'ETH/USDT', 'SOL/USDT']:
        test_wfo_config(sym, bounds, n_trials=80, min_trades_train=3, min_trades_oos=2, oos_dd_max=0.20, oos_pf_min=1.10)
