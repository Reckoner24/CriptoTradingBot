...
def optimize_for_symbol(sym):
    print(f"\\n========== OPTIMIZANDO {sym} PARA WIN RATE > 60% ==========")
    df = prepared_dfs[sym]
    ...
    def objective(trial):
        ...
        conf = trial.suggest_float('confidence', 0.50, 0.65) # Baja confianza para más trades
        sl_mult = trial.suggest_float('sl_mult', 0.8, 3.5)
