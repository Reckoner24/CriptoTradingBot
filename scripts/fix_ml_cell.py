...
def ejecutar_bot_ml_perfecto():
    print("1. Descargando historial completo para entrenamiento de la IA (5,000 velas x 4 monedas)...")
    ...
    for sym in symbols:
        ...
        # Eliminado el parámetro verbose para evitar el UserWarning
...
# The previous script appended the ML cell as the last cell.
# I will replace the last cell with this updated content.
if len(nb.cells) > 0:
    nb.cells[-1].source = ml_cell_content

with open(notebook_path, 'w', encoding='utf-8') as f:
    nbformat.write(nb, f)
print("Notebook updated with fixed ML cell (No verbose warnings + Plotly Candlesticks added).")
