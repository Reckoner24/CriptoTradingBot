...
symbols = ['BTC/USDT', 'ETH/USDT', 'BNB/USDT'] # Excluyendo SOL porque ya tiene parametros perfectos
...
def optimize_for_symbol(sym):
    ...
    def objective(trial):
        ...
        conf = trial.suggest_float('confidence', 0.60, 0.72)
        ...
        if trd < 8: # Mínimo de trades para evitar curve fitting extremo
            return 0
            
        # Maximizamos puramente el capital final en esta moneda
        return cap
