...
if __name__ == "__main__":
    best = {
        'max_depth': 4,
        'learning_rate': 0.09529734711717981,
        'reg_alpha': 1.0998762298794718,
        'reg_lambda': 6.530284687616882,
        'confidence': 0.7408168538569989,
        'sl_mult': 1.9930195300070537,
        'tp_mult': 3.249596793875568,
        'risk_pct': 0.41647107255599364
    }
    print("\\n=== PARÁMETROS SIN SESGO (10,000 VELAS) ===")
